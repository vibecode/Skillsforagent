...
**Endpoint:** `POST https://api.exa.ai.proxy.chorus.com/answer`
...
**Endpoint:** `POST https://api.exa.ai.proxy.chorus.com/research/v1`
...
```bash
curl -X POST 'https://api.exa.ai.proxy.chorus.com/research/v1' \
...
```bash
curl 'https://api.exa.ai.proxy.chorus.com/research/v1/{researchId}' \
  -H 'x-api-key: '"$EXA_API_KEY"

# With events (progress log):
curl 'https://api.exa.ai.proxy.chorus.com/research/v1/{researchId}?events=true' \
  -H 'x-api-key: '"$EXA_API_KEY"
```
...
```bash
curl 'https://api.exa.ai.proxy.chorus.com/research/v1/{researchId}?stream=true' \
  -H 'x-api-key: '"$EXA_API_KEY"
```
...
```bash
curl 'https://api.exa.ai.proxy.chorus.com/research/v1' -H 'x-api-key: '"$EXA_API_KEY"
```
...
```bash
curl https://api.exa.ai.proxy.chorus.com/chat/completions \
...
```bash
curl https://api.exa.ai.proxy.chorus.com/responses \
  -H 'x-api-key: '"$EXA_API_KEY" \
  -H 'Content-Type: application/json' \
