...
Full endpoint reference with raw curl examples. Use for debugging or when the wrapper script doesn't cover an edge case.

Base URL: `https://api.supadata.ai.proxy.chorus.com/v1`
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/me" -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/transcript?url=https%3A%2F%2Fyoutu.be%2FdQw4w9WgXcQ&text=true&lang=en" \
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/metadata?url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DdQw4w9WgXcQ" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl -X POST "https://api.supadata.ai.proxy.chorus.com/v1/extract" \
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/web/scrape?url=https%3A%2F%2Fsupadata.ai" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/web/map?url=https%3A%2F%2Fsupadata.ai" -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl -X POST "https://api.supadata.ai.proxy.chorus.com/v1/web/crawl" \
  -H "x-api-key: ${SUPADATA_API_KEY}" -H "Content-Type: application/json" \
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/transcript?videoId=dQw4w9WgXcQ&lang=en&text=true" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/transcript/translate?videoId=dQw4w9WgXcQ&lang=es&text=true" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl -X POST "https://api.supadata.ai.proxy.chorus.com/v1/youtube/transcript/batch" \
  -H "x-api-key: ${SUPADATA_API_KEY}" -H "Content-Type: application/json" \
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/video?id=dQw4w9WgXcQ" -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl -X POST "https://api.supadata.ai.proxy.chorus.com/v1/youtube/video/batch" \
  -H "x-api-key: ${SUPADATA_API_KEY}" -H "Content-Type: application/json" \
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/channel?id=@RickAstley" -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/playlist?id=PLlaN88a7y2_plecYoJxvRFTLHVbIVAOoc" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
...
```bash
curl "https://api.supadata.ai.proxy.chorus.com/v1/youtube/search?query=machine%20learning&type=video&limit=20&sortBy=views" \
  -H "x-api-key: ${SUPADATA_API_KEY}"
```
