...
| `.resizeFill` | Preserved | Scene resizes to match view | Adaptive scenes |
| `.fill` | Distorted | Scales each axis independently | Almost never |
...
// Basic embedding — hold scene in @State so SwiftUI redraws don't recreate it
