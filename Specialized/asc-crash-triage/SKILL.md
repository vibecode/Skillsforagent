...
display_name: ASC Crash Triage
description: >
  Real App Store Connect CLI crash triage guidance. Use when:
  (1) pulling TestFlight crash submissions, beta feedback, screenshots, or
  build-scoped crash data with asc, (2) summarizing iOS beta crash volume,
  affected builds, devices, OS versions, or timelines, (3) fetching App Store
  Connect performance diagnostics for hangs, disk writes, launches, or logs,
  (4) resolving app and build IDs before triage, (5) distinguishing real ASC
  data gaps from actual crash signals.
metadata:
  openclaw:
    emoji: "🛟"
---

<!-- Source: rorkai/app-store-connect-cli-skills skills/asc-crash-triage. License: MIT. Marketplace frontmatter adjusted; upstream guidance preserved. -->
