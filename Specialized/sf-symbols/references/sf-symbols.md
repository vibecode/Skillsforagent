...
#### Related Skills
- Use `sf-symbols-ref.md` for complete API reference with all modifiers, UIKit equivalents, and platform availability matrix
...
**Skills**: sf-symbols-ref.md (complete API reference)
