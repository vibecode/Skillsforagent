...
#### Not covered here
- App crashes at runtime (not preview): use Xcode crash logs and LLDB
- Build failures: check Xcode build output directly
- async/await or MainActor data races: use Swift concurrency documentation
