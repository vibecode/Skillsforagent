...
- Use `skills/nav-ref.md` for full API reference (including Tab customization, iOS 26+ features) with all WWDC examples
...
- Red flag: **"Let's build a full coordinator layer before any views"** -> Usually YAGNI
- Red flag: **"We need a navigation architecture that handles anything"** -> Scope creep
- Red flag: **"Instagram/TikTok does it this way"** -> They have 100+ engineers
...
- Red flag: NavigationView deprecated since iOS 16 (2022)
- Red flag: Different behavior across iOS versions causes bugs
- Red flag: No NavigationPath support  -  can't deep link properly
...
**Platforms** iOS 16+, iPadOS 16+, macOS 13+, watchOS 9+, tvOS 16+ (base NavigationStack patterns); iOS 26+ focus for additions covered by this skill
