...
**NEW in WWDC 2025**: Next-generation SwiftUI instrument in Instruments 26 provides full performance analysis with:
...
**Cross-reference** SwiftUI 26 Features (`skills/26-ref.md`)  -  full guide to all iOS 26 SwiftUI changes
...
Warning: **AVOID storing frequently-changing values in environment**:
